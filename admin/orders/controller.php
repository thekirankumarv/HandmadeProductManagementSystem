	...
	function doEdit(){
  	...
  	// 		$res = $customer->single_customer($_GET['customerid']); 
			...
			foreach ($cur as $result) {
	  		 ...
	  		 $sql = "INSERT INTO `messageout` (`Id`, `MessageTo`, `MessageFrom`, `MessageText`) VALUES (Null, '".$result->OWNERPHONE."','Janno','FROM Bachelor of Science and Entrepreneurs : Your  product has been ordered')";
	        $mydb->setQuery($sql);
	        $mydb->executeQuery();
